      ...
      <AnimatePresence>
        {!isOpen && (
          <div className="absolute inset-0 z-50 flex flex-col md:flex-row pointer-events-none">
            ...
            >
              <h1 className="text-4xl md:text-6xl lg:text-8xl font-black tracking-[-0.05em] uppercase bg-clip-text text-transparent bg-gradient-to-b from-white to-slate-500 font-sans">
                Sampanna
              </h1>
            </motion.div>
            ...
            >
              <h1 className="text-4xl md:text-6xl lg:text-8xl font-black tracking-[-0.05em] uppercase text-slate-100 font-sans">
                Mahapatra
              </h1>
            </motion.div>
          </div>
